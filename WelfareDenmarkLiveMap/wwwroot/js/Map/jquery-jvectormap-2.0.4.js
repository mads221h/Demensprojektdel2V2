...
jvm.Map.prototype = {
    ...
    bindZoomButtons: function () {
        ...
        jvm.$('<div title="Zoom ud"/>').addClass('jvectormap-reset').html('&middot;').appendTo(this.container);
        ...
        this.container.find('.jvectormap-reset').click(function () {
            map.setScale(0, map.width / 2, map.height / 2, false, map.params.zoomAnimate);
        });
    },
